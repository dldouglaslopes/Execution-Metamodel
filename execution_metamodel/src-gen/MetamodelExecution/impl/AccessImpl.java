...
public class AccessImpl extends MinimalEObjectImpl.Container implements Access {
	...
	protected EClass eStaticClass() {
		return Execution_metamodelPackage.Literals.ACCESS;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Execution_metamodelPackage.ACCESS__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Execution_metamodelPackage.ACCESS__NAME, oldName,
					name));
	}
	...
	public void setCode(int newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Execution_metamodelPackage.ACCESS__CODE, oldCode,
					code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Execution_metamodelPackage.ACCESS__ID:
			return getId();
