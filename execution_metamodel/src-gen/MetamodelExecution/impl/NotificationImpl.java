 ...
 * </p>
 * <ul>
 *   <li>{@link MetamodelExecution.impl.NotificationImpl#getId <em>Id</em>}</li>
 *   <li>{@link MetamodelExecution.impl.NotificationImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link MetamodelExecution.impl.NotificationImpl#getRequestDate <em>Request Date</em>}</li>
 *   <li>{@link MetamodelExecution.impl.NotificationImpl#isSuccess <em>Success</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NotificationImpl extends MinimalEObjectImpl.Container implements Notification {
	...
	protected EClass eStaticClass() {
		return Execution_metamodelPackage.Literals.NOTIFICATION;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET,
					Execution_metamodelPackage.NOTIFICATION__ID, oldId, id));
	}
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET,
					Execution_metamodelPackage.NOTIFICATION__MESSAGE, oldMessage, message));
	}
	...
	public void setRequestDate(Date newRequestDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET,
					Execution_metamodelPackage.NOTIFICATION__REQUEST_DATE, oldRequestDate, requestDate));
	}
	...
	public void setSuccess(boolean newSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET,
					Execution_metamodelPackage.NOTIFICATION__SUCCESS, oldSuccess, success));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Execution_metamodelPackage.NOTIFICATION__ID:
			return getId();
		case Execution_metamodelPackage.NOTIFICATION__MESSAGE:
			return getMessage();
		case Execution_metamodelPackage.NOTIFICATION__REQUEST_DATE:
			return getRequestDate();
		case Execution_metamodelPackage.NOTIFICATION__SUCCESS:
			return isSuccess();
		}
