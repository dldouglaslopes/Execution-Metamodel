 ...
 * </p>
 * <ul>
 *   <li>{@link MetamodelExecution.impl.ResponsibleImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponsibleImpl extends MinimalEObjectImpl.Container implements Responsible {
	...
	protected EClass eStaticClass() {
		return Execution_metamodelPackage.Literals.RESPONSIBLE;
	}
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Execution_metamodelPackage.RESPONSIBLE__DATA, oldData, data));
			}
		}
		return data;
	}
