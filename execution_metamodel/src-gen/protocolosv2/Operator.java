 ...
 * <!-- end-user-doc -->
 * @see protocolosv2.Protocolosv2Package#getOperator()
...
public enum Operator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final Operator[] VALUES_ARRAY = new Operator[] { NOT, AND, OR, IMPLIES, EQUAL, BIGGER_THAN,
			SMALLER_THAN, EQUAL_OR_GREATER, EQUAL_OR_SMALLER, XOR, SUM, MINUS, MULTIPLICATION, DIVISION, AFFIRMATION, };
	...
	public static Operator get(int value) {
		...
		case SMALLER_THAN_VALUE:
			return SMALLER_THAN;
		case EQUAL_OR_GREATER_VALUE:
			return EQUAL_OR_GREATER;
		case EQUAL_OR_SMALLER_VALUE:
