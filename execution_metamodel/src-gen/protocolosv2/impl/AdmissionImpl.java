...
public class AdmissionImpl extends MinimalEObjectImpl.Container implements Admission {
	...
	public void setAdmission(String newAdmission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.ADMISSION__ADMISSION,
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.ADMISSION__REASON, oldReason,
					reason));
	}
	...
	public void setClinical_indication(String newClinical_indication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.ADMISSION__CLINICAL_INDICATION,
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.ADMISSION__QUANTITY, oldQuantity,
					quantity));
	}
