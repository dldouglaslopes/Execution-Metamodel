 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.AuxiliaryConductImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuxiliaryConductImpl extends ElementImpl implements AuxiliaryConduct {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.AUXILIARY_CONDUCT;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this,
					Protocolosv2Package.AUXILIARY_CONDUCT__QUESTIONS);
		}
		return questions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Protocolosv2Package.AUXILIARY_CONDUCT__QUESTIONS:
