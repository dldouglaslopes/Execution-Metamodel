 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link protocolosv2.impl.CategoryImpl#getQuestion <em>Question</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.CATEGORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.CATEGORY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Protocolosv2Package.CATEGORY__NAME:
			return getName();
