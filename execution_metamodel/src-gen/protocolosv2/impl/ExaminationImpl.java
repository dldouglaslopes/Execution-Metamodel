 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getExam_id <em>Exam id</em>}</li>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getLimb_side <em>Limb side</em>}</li>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link protocolosv2.impl.ExaminationImpl#getClinical_indication <em>Clinical indication</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExaminationImpl extends MinimalEObjectImpl.Container implements Examination {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.EXAMINATION;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__URL, oldUrl, url));
	}
	...
	public void setExam_id(int newExam_id) {
		...
		exam_id = newExam_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__EXAM_ID, oldExam_id,
					exam_id));
	}
	...
	public void setLimb_side(String newLimb_side) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__LIMB_SIDE,
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__QUANTITY,
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__REASON, oldReason,
					reason));
	}
	...
	public void setClinical_indication(String newClinical_indication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__CLINICAL_INDICATION,
					oldClinical_indication, clinical_indication));
	}
