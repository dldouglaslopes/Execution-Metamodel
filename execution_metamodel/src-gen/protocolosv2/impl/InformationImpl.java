 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.InformationImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InformationImpl extends ElementImpl implements Information {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.INFORMATION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.INFORMATION__TEXT, oldText,
					text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Protocolosv2Package.INFORMATION__TEXT:
			return getText();
		}
