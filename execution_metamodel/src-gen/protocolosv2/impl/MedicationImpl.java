 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getMed_id <em>Med id</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getId <em>Id</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getName <em>Name</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getBrand <em>Brand</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isStandardized <em>Standardized</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isControlled <em>Controlled</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isConsigned <em>Consigned</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isCritical <em>Critical</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isInvasive <em>Invasive</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#isOutpatient <em>Outpatient</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getDaily_dosage <em>Daily dosage</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getCycles <em>Cycles</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getTreatement_time <em>Treatement time</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link protocolosv2.impl.MedicationImpl#getStandard <em>Standard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationImpl extends MinimalEObjectImpl.Container implements Medication {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.MEDICATION;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__URL, oldUrl, url));
	}
	...
	public void setCode(int newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CODE, oldCode, code));
	}
	...
	public void setMed_id(int newMed_id) {
		...
		med_id = newMed_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__MED_ID, oldMed_id,
					med_id));
	}
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__DESCRIPTION,
	...
	public void setBrand(String newBrand) {
		...
		brand = newBrand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__BRAND, oldBrand,
					brand));
	}
	...
	public void setStandardized(boolean newStandardized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__STANDARDIZED,
	...
	public void setControlled(boolean newControlled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CONTROLLED,
	...
	public void setConsigned(boolean newConsigned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CONSIGNED,
	...
	public void setCritical(boolean newCritical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CRITICAL, oldCritical,
					critical));
	}
	...
	public void setInvasive(boolean newInvasive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__INVASIVE, oldInvasive,
					invasive));
	}
	...
	public void setOutpatient(boolean newOutpatient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__OUTPATIENT,
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__UNIT, oldUnit, unit));
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__ACCESS, oldAccess,
					access));
	}
	...
	public void setDaily_dosage(int newDaily_dosage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__DAILY_DOSAGE,
	...
	public void setCycles(int newCycles) {
		...
		cycles = newCycles;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CYCLES, oldCycles,
					cycles));
	}
	...
	public void setTreatement_time(int newTreatement_time) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__TREATEMENT_TIME,
	...
	public void setFrequency(int newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__FREQUENCY,
	...
	public void setStandard(String newStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__STANDARD, oldStandard,
					standard));
	}
