...
public class NumericImpl extends VariableImpl implements Numeric {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.NUMERIC;
	}
	...
	public void setWeight(int newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.NUMERIC__WEIGHT, oldWeight,
					weight));
	}
	...
	public void setValue(Double newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.NUMERIC__VALUE, oldValue, value));
	}
