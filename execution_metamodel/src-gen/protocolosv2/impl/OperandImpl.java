 ...
 * </p>
 * <ul>
 *   <li>{@link protocolosv2.impl.OperandImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperandImpl extends MinimalEObjectImpl.Container implements Operand {
	...
	protected EClass eStaticClass() {
		return Protocolosv2Package.Literals.OPERAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.OPERAND__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Protocolosv2Package.OPERAND__NAME:
			return getName();
		}
