...
public class Protocolosv2FactoryImpl extends EFactoryImpl implements Protocolosv2Factory {
	...
	public static Protocolosv2Factory init() {
		try {
			Protocolosv2Factory theProtocolosv2Factory = (Protocolosv2Factory) EPackage.Registry.INSTANCE
					.getEFactory(Protocolosv2Package.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case Protocolosv2Package.NUMERIC:
			return createNumeric();
		case Protocolosv2Package.YES_OR_NO:
			return createYesOrNo();
		case Protocolosv2Package.AUXILIARY_CONDUCT:
			return createAuxiliaryConduct();
		case Protocolosv2Package.QUESTION:
			return createQuestion();
		case Protocolosv2Package.PROTOCOL:
			return createProtocol();
		case Protocolosv2Package.PRESCRIPTION:
			return createPrescription();
		case Protocolosv2Package.DISCHARGE:
			return createDischarge();
		case Protocolosv2Package.REFERRAL:
			return createReferral();
		case Protocolosv2Package.TREATMENT:
			return createTreatment();
		case Protocolosv2Package.INFORMATION:
			return createInformation();
		case Protocolosv2Package.SEQUENCE:
			return createSequence();
		case Protocolosv2Package.OPERATION:
			return createOperation();
		case Protocolosv2Package.CATEGORY:
			return createCategory();
		case Protocolosv2Package.EXAMINATION:
			return createExamination();
		case Protocolosv2Package.MEDICATION:
			return createMedication();
		case Protocolosv2Package.PROCEDURE:
