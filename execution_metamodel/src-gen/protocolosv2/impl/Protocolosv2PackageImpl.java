...
import MetamodelExecution.impl.Execution_metamodelPackageImpl;
...
public class Protocolosv2PackageImpl extends EPackageImpl implements Protocolosv2Package {
	...
	public static Protocolosv2Package init() {
		if (isInited)
			return (Protocolosv2Package) EPackage.Registry.INSTANCE.getEPackage(Protocolosv2Package.eNS_URI);

		// Obtain or create and register package
		Protocolosv2PackageImpl theProtocolosv2Package = (Protocolosv2PackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof Protocolosv2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new Protocolosv2PackageImpl());
		...
		Execution_metamodelPackageImpl theExecution_metamodelPackage = (Execution_metamodelPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(Execution_metamodelPackage.eNS_URI) instanceof Execution_metamodelPackageImpl
						? EPackage.Registry.INSTANCE.getEPackage(Execution_metamodelPackage.eNS_URI)
						: Execution_metamodelPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProtocol_Code(), ecorePackage.getEString(), "code", null, 0, 1, Protocol.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProtocol_Sequence(), this.getSequence(), null, "sequence", null, 0, -1, Protocol.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProtocol_Category(), this.getCategory(), null, "category", null, 0, -1, Protocol.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProtocol_Operation(), this.getOperation(), null, "operation", null, 0, -1, Protocol.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProtocol_Variable(), this.getVariable(), null, "variable", null, 0, -1, Protocol.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(referralEClass, Referral.class, "Referral", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferral_Protocol(), this.getProtocol(), null, "protocol", null, 1, -1, Referral.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMedication_Brand(), ecorePackage.getEString(), "brand", null, 0, 1, Medication.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMedication_Standardized(), ecorePackage.getEBoolean(), "standardized", null, 0, 1,
				Medication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMedication_Controlled(), ecorePackage.getEBoolean(), "controlled", null, 0, 1,
				Medication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMedication_Consigned(), ecorePackage.getEBoolean(), "consigned", null, 0, 1, Medication.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMedication_Critical(), ecorePackage.getEBoolean(), "critical", null, 0, 1, Medication.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMedication_Invasive(), ecorePackage.getEBoolean(), "invasive", null, 0, 1, Medication.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
