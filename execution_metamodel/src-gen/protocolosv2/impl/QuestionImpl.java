...
public class QuestionImpl extends MinimalEObjectImpl.Container implements Question {
	...
	public EList<Variable> getAnswers() {
		if (answers == null) {
			answers = new EObjectContainmentEList<Variable>(Variable.class, this,
					Protocolosv2Package.QUESTION__ANSWERS);
		}
		return answers;
	}
	...
	public Category getCategory() {
		if (category != null && category.eIsProxy()) {
			...
			if (category != oldCategory) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Protocolosv2Package.QUESTION__CATEGORY,
	...
	public NotificationChain basicSetCategory(Category newCategory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Protocolosv2Package.QUESTION__CATEGORY, oldCategory, newCategory);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCategory(Category newCategory) {
		if (newCategory != category) {
			...
			if (category != null)
				msgs = ((InternalEObject) category).eInverseRemove(this, Protocolosv2Package.CATEGORY__QUESTION,
						Category.class, msgs);
			if (newCategory != null)
				msgs = ((InternalEObject) newCategory).eInverseAdd(this, Protocolosv2Package.CATEGORY__QUESTION,
						Category.class, msgs);
			msgs = basicSetCategory(newCategory, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.QUESTION__CATEGORY, newCategory,
					newCategory));
	}
