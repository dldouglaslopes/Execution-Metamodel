...
public class SequenceImpl extends MinimalEObjectImpl.Container implements Sequence {
		...
		if (inputStep != null && inputStep.eIsProxy()) {
			...
			if (inputStep != oldInputStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Protocolosv2Package.SEQUENCE__INPUT_STEP,
							oldInputStep, inputStep));
			}
		}
		return inputStep;
	}
	...
	public NotificationChain basicSetInputStep(Element newInputStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Protocolosv2Package.SEQUENCE__INPUT_STEP, oldInputStep, newInputStep);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInputStep(Element newInputStep) {
		if (newInputStep != inputStep) {
			...
			if (inputStep != null)
				msgs = ((InternalEObject) inputStep).eInverseRemove(this, Protocolosv2Package.ELEMENT__INPUT_SEQUENCES,
						Element.class, msgs);
			if (newInputStep != null)
				msgs = ((InternalEObject) newInputStep).eInverseAdd(this, Protocolosv2Package.ELEMENT__INPUT_SEQUENCES,
						Element.class, msgs);
			msgs = basicSetInputStep(newInputStep, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.SEQUENCE__INPUT_STEP,
	...
	public Element getOutputStep() {
		if (outputStep != null && outputStep.eIsProxy()) {
			...
			if (outputStep != oldOutputStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Protocolosv2Package.SEQUENCE__OUTPUT_STEP,
	...
	public NotificationChain basicSetOutputStep(Element newOutputStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Protocolosv2Package.SEQUENCE__OUTPUT_STEP, oldOutputStep, newOutputStep);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newOutputStep != outputStep) {
			...
			if (outputStep != null)
				msgs = ((InternalEObject) outputStep).eInverseRemove(this,
						Protocolosv2Package.ELEMENT__OUTPUT_SEQUENCES, Element.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.SEQUENCE__OUTPUT_STEP,
	...
	public void setType_verbose(String newType_verbose) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.SEQUENCE__TYPE_VERBOSE,
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.SEQUENCE__DESCRIPTION,
	...
	public NotificationChain basicSetOperation(Operation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Protocolosv2Package.SEQUENCE__OPERATION, oldOperation, newOperation);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject) operation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Protocolosv2Package.SEQUENCE__OPERATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.SEQUENCE__OPERATION, newOperation,
					newOperation));
	}
